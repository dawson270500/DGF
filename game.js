...
var fps;
function EngineLoop(){
    for (const [key2, ObjectBeenChecked] of Object.entries(GameObjects)) {
        if(ObjectBeenChecked.Updater == true){
            ObjectBeenChecked.OnUpdate(); // If it has a OnUpdate call it
        }
    }
    CollisionCheck();
    render();
...
function CollisionCheck(){
    for (const [key1, ObjectChecking] of Object.entries(GameObjects)) {
        if(!ObjectChecking.collision){
            ...
            for (const [key2, ObjectBeenChecked] of Object.entries(GameObjects)) {
                if(!ObjectBeenChecked.collision || ObjectBeenChecked.name == ObjectChecking.name){
                    continue;
                }
                if(ObjectChecking.Position.locX > ObjectBeenChecked.Position.locX && 
                     ObjectChecking.Position.locX + ObjectChecking.Position.width < ObjectBeenChecked.Position.locX + ObjectBeenChecked.Position.width ||
                     ObjectChecking.Position.width + ObjectChecking.Position.locX > ObjectBeenChecked.Position.locX &&
                     ObjectChecking.Position.locX + ObjectChecking.Position.width < ObjectBeenChecked.Position.locX + ObjectBeenChecked.Position.width
                     || ObjectChecking.Position.locX > ObjectBeenChecked.Position.locX && 
                     ObjectChecking.Position.locX < ObjectBeenChecked.Position.locX + ObjectBeenChecked.Position.width){
                    // Within the width of the object
                    if(ObjectChecking.Position.locY > ObjectBeenChecked.Position.locY &&
                         ObjectChecking.Position.locY + ObjectChecking.Position.height < ObjectBeenChecked.Position.locY + ObjectBeenChecked.Position.height 
                         || ObjectChecking.Position.height + ObjectChecking.Position.locY > ObjectBeenChecked.Position.locY && 
                         ObjectChecking.Position.locY + ObjectChecking.Position.height < ObjectBeenChecked.Position.locY + ObjectBeenChecked.Position.height
                         || ObjectChecking.Position.locY < ObjectBeenChecked.Position.locY + ObjectBeenChecked.Position.height 
                         && ObjectChecking.Position.locY > ObjectBeenChecked.Position.locY){
                        // Within the height of the object
                        if(ObjectChecking.OnColide instanceof Function){
                            ObjectChecking.OnColide(ObjectBeenChecked); // If it has a oncolide, call it
